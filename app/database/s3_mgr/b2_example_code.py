...
NEW_BUCKET_NAME = 'junk-bucket-3'
TRANSIENT_BUCKET_NAME = 'junk-bucket-4'

file1 = "beach.jpg"     # Sample Data - files in public Bucket with Sample Data
file1_pri = "beach3.jpg"
file2 = "coconuts.jpg"
file3 = "sunset.jpg"
LOCAL_DIR = '/Users/tegancounts/Library/CloudStorage/OneDrive-Personal/personal-finances-app'  # <-- Make sure this directory exists on your local machine; adjust name per your operating system
